'''
Подложка острова Arma: Cold War Assault площадь 9.92 кв. км
Автор Виктор Бутырин (publius)
Версия 1.5
Привязка к масштабу Cold War Assault:
	1.0000 blender == 100 м CWA
	0.5000 blender ==  50 м CWA
	0.1000 blender ==  10 м CWA
	0.0100 blender ==   1 м CWA
'''
